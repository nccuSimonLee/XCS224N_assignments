...
def pad_sents_char(sents, char_pad_token):
    ...
    sents_padded = [sent + [[char_pad_token] for _ in range(max_sent_length - len(sent))]
                    for sent in sents]
    sents_padded = [[(word + [char_pad_token] * max(max_word_length - len(word), 0))[:max_word_length]
